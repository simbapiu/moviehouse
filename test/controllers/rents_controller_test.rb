...
class RentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rent" do
    assert_difference('Rent.count') do
      post rents_url, params: { rent: { movie_id: @rent.movie_id, price: @rent.price, rent_day: @rent.rent_day, return_day: @rent.return_day, user_id: @rent.user_id } }
    end
  ...
  test "should update rent" do
    patch rent_url(@rent), params: { rent: { movie_id: @rent.movie_id, price: @rent.price, rent_day: @rent.rent_day, return_day: @rent.return_day, user_id: @rent.user_id } }
